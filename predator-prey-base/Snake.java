...
/**
 * A model of a snake.
 * snakes age, move, breed, die (from hunger, age or getting eaten), hunt, get sick and pass on sickness
 *
...
public class Snake extends Animal{            //PURPLE SQUARE IN FIELD
    ...
    private void passOnSickness() {
     ...
     /**
     * snake scane the adjacent rooms for a mate, must be a snake.
     */
    ...
    /**
     * return the number of births per snake
     */
