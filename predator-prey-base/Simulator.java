...
public class Simulator {
    ...
    private static final double RABBIT_CREATION_PROBABILITY = 0.22;   
    private static final double HAWK_CREATION_PROBABILITY = 0.03;     
    private static final double SNAKE_CREATION_PROBABILITY = 0.12;    
    private static final double FROG_CREATION_PROBABILITY = 0.18;     
    private static final double MOUSE_CREATION_PROBABILITY = 0.18;    
    private static final double GRASSHOPPER_CREATION_PROBABILITY = 0.4;  
